...
import { groupList, groups } from './groups/groups.reducer';
...
const rootReducer = combineReducers({ login, studentsReducer, groupList, groups, teachersReducer, setPassword, changePassword, forgotPassword,  updateUserProfile });
